...
*/
var LoadingState = new KiwiLoadingScreen('LoadingState','IntroState',{width:350530,height: 350	}, 'assets/img/loading/');
...
LoadingState.preload = function () {
    ...
    this.addImage('scoreBar', 'assets/img/scoreBar.png', true, 480, 120);

    this.addSpriteSheet('fruits', 'assets/img/fruit.png', 40, 40);
    game.stage.resize(280,530)
